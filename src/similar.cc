 ...
 */
bool Similar::areSimilar(const Game& game1, const Game& game2, double tolerance) {
...
double Similar::compareTokens(const vector<string>& tag1, const vector<string>& tag2) {
    int similar_score = 0;
    for (auto str1 : tag1) {
        for (auto str2 : tag2) {
