...
bool testSimilarClass() {
  ...
  game1.game_description = "in this game you will battle the hardest enemies ever";
  game2.game_description = "in this game you fight the most daring enemies ever";
  ...
  game2.genre = "adventure,gory,shooter,puzzle,violence";
  game1.game_description = "in this game you find your way through challenging puzzles";
  game2.game_description = "in this game you fight the most daring enemies ever";
...
int main(int argc, char* argv[]) {
  ...
  if (test_case_similar) {passed_cases++;}
  else {failed_cases++;}
